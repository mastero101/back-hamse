...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    const defaultRequirements = [
      ...
      // PEMEX
      { id: Sequelize.literal('gen_random_uuid()'), dependency: 'PEMEX', title: 'Fianzas', description: 'Fianzas para compra de Combustible', periodicity: 'Único', period: 'Eventual', completed: false, hasProvidersButton: false, videoUrl: defaultVideoUrl, respaldo: JSON.stringify({ url: '', nota: '' }), createdAt: new Date(), updatedAt: new Date() },
      ...
      { id: Sequelize.literal('gen_random_uuid()'), dependency: 'SIN-MUN', subTitle: 'MUNICIPALES', title: 'Prediales', description: '', periodicity: 'Anual', period: 'Enero', completed: false, hasProvidersButton: false, videoUrl: defaultVideoUrl, respaldo: JSON.stringify({ url: '', nota: '' }), createdAt: new Date(), updatedAt: new Date() },
      { id: Sequelize.literal('gen_random_uuid()'), dependency: 'SIN-MUN', subTitle: 'MUNICIPALES', title: 'Convenio Bomberos', description: '', periodicity: 'Anual', period: 'Previo al vencimiento', completed: false, hasProvidersButton: false, videoUrl: defaultVideoUrl, respaldo: JSON.stringify({ url: '', nota: '' }), createdAt: new Date(), updatedAt: new Date() },
      { id: Sequelize.literal('gen_random_uuid()'), dependency: 'SIN-MUN', subTitle: 'MUNICIPALES', title: 'Anuencias de Preciador', description: '', periodicity: 'Anual', period: 'Enero', completed: false, hasProvidersButton: false, videoUrl: defaultVideoUrl, respaldo: JSON.stringify({ url: '', nota: '' }), createdAt: new Date(), updatedAt: new Date() },
